      ...
      <div className="space-y-6">
        ...
        <div className="glass-card rounded-xl p-5 border border-gray-800/60">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              { dept: 'Human Resources',        color: '#8B5CF6', agent: 'AI Intern',             email: 'ai.intern@ticketiq.com' },
              { dept: 'Information Technology', color: '#3B82F6', agent: 'IT Support Technician', email: 'it.agent@ticketiq.com' },
              { dept: 'Finance',                color: '#10B981', agent: 'IT Support Technician', email: 'it.agent@ticketiq.com' },
              { dept: 'Operations',             color: '#F59E0B', agent: 'Junior Operations',      email: 'ops.agent@ticketiq.com' },
            ].map((r, i) => (
